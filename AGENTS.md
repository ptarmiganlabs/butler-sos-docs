...
This project is indexed by GitNexus as **butler-sos-docs** (962 symbols, 977 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
