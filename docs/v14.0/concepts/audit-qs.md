...
If you enable screenshot downloads, Butler SOS can fetch image URLs emitted by Audit.qs and store the resulting files server-side. For configuration and runtime details, see [Audit Screenshots](/v14.0/getting-started/setup/audit-screenshots) and [Screenshot Downloads](/v14.0/reference/audit-destinations/png/downloads).
