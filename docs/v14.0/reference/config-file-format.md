...
| `anonTelemetry` | Can Butler SOS share anonymous data about itself with the Butler SOS project? More info in [telemetry docs](/v14.0/about/telemetry) |

---

### Butler-SOS.crashFile

Controls whether Butler SOS creates crash dump files when it encounters unrecoverable errors. See [Crash Dump](/v14.0/getting-started/setup/crash-dump) for full details.
...
- [Screenshot Downloads](/v14.0/reference/audit-destinations/png/downloads)
