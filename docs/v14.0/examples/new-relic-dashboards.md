...
1. Set up Butler SOS to send data to New Relic (see [Data Destinations: New Relic](/v14.0/concepts/data-destinations/new-relic))
...
- [Data Destinations: New Relic](/v14.0/concepts/data-destinations/new-relic) - Configuration details
- [Available Metrics: New Relic](/v14.0/reference/available-metrics/new-relic) - Metrics reference
