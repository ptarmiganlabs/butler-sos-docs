...
Assuming you've already completed the [configuration of Butler SOS](/v14.0/reference/config-file-format), the result of running the `docker-compose_fullstack_influxdb.yml` file above is something like this:
...
<ResponsiveImage
  src="./grafana-influxdb-datasource-1.png"
  alt="Adding an InfluxDB data source in Grafana"
  caption="Configuring the InfluxDB data source connection in Grafana"
  maxWidth="900px"
/>
...
<ResponsiveImage
  src="./grafana-chart-1.png"
  alt="Butler SOS' own memory usage, stored in InfluxDB and visualized in Grafana"
  caption="Real-time memory usage visualization showing Butler SOS performance metrics in Grafana"
  maxWidth="800px"
/>
