...
It's recommended to use [log events](/v14.0/getting-started/setup/qlik-sense-events/log-events) instead, as they provide a more flexible and scalable way to capture log events from Qlik Sense.
:::
...
Butler SOS offers a replacement for log db, in the form of [log events](/v14.0/getting-started/setup/qlik-sense-events/log-events).
