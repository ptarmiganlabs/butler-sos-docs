...
By far the most common use case is to store the metrics in InfluxDB. If you already have Prometheus deployed you can use it instead of InfluxDB, see the [Prometheus config page](/v14.0/getting-started/setup/prometheus).
...
Butler-SOS:
  ...
  influxdbConfig:
    ...
    version: 1                      # Is the InfluxDB instance version 1.x, 2.x or 3.x? Valid values are 1, 2 or 3
