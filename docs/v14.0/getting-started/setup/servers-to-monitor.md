...
Note that there is a dependency to the `Butler-SOS.userSessions` section. Please see the [Configuring user sessions](/v14.0/getting-started/setup/user-sessions) page for more info.
