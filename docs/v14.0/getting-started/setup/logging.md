...
For information on crash dump files that Butler SOS can create when it encounters unrecoverable errors, see [Crash Dump](/v14.0/getting-started/setup/crash-dump).
...
For a detailed explanation of what "chunk" and "points" mean, see the [InfluxDB concepts page](/v14.0/concepts/data-destinations/influxdb#understanding-influxdb-write-log-messages).
