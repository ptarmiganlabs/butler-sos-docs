...
For a detailed explanation of what "chunk" and "points" mean, see the [InfluxDB concepts page](/docs/concepts/data-destinations/influxdb#understanding-influxdb-write-log-messages).
