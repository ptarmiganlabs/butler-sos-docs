...
- [Failed Poll Metrics](/docs/reference/available-metrics/failed-polls) for the exact InfluxDB schema used by these events
- [Error Tracking](/docs/concepts/features/error-tracking) for the broader Butler SOS error-tracking model