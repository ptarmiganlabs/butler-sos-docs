...
If you need one JSON file per `objectData` payload, use the [JSON destination](/docs/reference/audit-destinations/json/) in addition to InfluxDB.

## Related Topics

- [Audit Event Destinations](/docs/reference/audit-destinations/)
- [JSON Destination](/docs/reference/audit-destinations/json/)