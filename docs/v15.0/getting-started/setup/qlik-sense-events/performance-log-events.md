...
The accepted performance log events stored in InfluxDB are described in the [reference documentation](/v15.0/reference/available-metrics/influxdb#source-engine-service-performance-related-events).

## Metrics for Rejected Performance Log Events

The rejected performance log events stored in InfluxDB are described in the [reference documentation](/v15.0/reference/available-metrics/influxdb#source-engine-service-performance-related-events).
