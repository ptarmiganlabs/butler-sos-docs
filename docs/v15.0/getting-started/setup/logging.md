...
For information on crash dump files that Butler SOS can create when it encounters unrecoverable errors, see [Crash Dump](/v15.0/getting-started/setup/crash-dump).
...
For a detailed explanation of what "chunk" and "points" mean, see the [InfluxDB concepts page](/v15.0/concepts/data-destinations/influxdb#understanding-influxdb-write-log-messages).
