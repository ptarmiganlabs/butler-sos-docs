...
By far the most common use case is to store the metrics in InfluxDB. If you already have Prometheus deployed you can use it instead of InfluxDB, see the [Prometheus config page](/v15.0/getting-started/setup/prometheus).
