...
A description of Butler SOS's telemetry feature is available in the [About section](/v15.0/about/telemetry).
...
Butler-SOS:
  ...
  anonTelemetry: true           # Can Butler SOS send anonymous data about what computer it is running on?
                                # More info on what data is collected: https://butler-sos.ptarmiganlabs.com/v15.0/about/telemetry/
