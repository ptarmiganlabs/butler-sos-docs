...
That said, it is probably better system design to run Butler SOS (and maybe other members of the [Butler family](/v15.0/about/butler-family)) on their own server, maybe using some flavour of Linux (lower cost compared to Windows). Windows servers work equally well though.
...
- [Docker Installation](/v15.0/getting-started/install/docker)
- [Windows, Linux, macOS Installation](/v15.0/getting-started/install/windows)
- [InfluxDB & Grafana Setup](/v15.0/getting-started/install/influxdb-grafana)
- [Prometheus & Grafana Setup](/v15.0/getting-started/install/prometheus-grafana)

## Next Steps

After installation, proceed to:

- [Day 2 Operations](/v15.0/getting-started/operations/)
- [Configuration Reference](/v15.0/reference/config-file-format)
