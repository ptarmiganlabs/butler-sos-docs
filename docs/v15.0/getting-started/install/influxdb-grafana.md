...
Assuming you've already completed the [configuration of Butler SOS](/v15.0/reference/config-file-format), the result of running the `docker-compose_fullstack_influxdb.yml` file above is something like this:
