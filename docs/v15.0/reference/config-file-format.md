...
| `anonTelemetry` | Can Butler SOS share anonymous data about itself with the Butler SOS project? More info in [telemetry docs](/v15.0/about/telemetry) |

---

### Butler-SOS.crashFile

Controls whether Butler SOS creates crash dump files when it encounters unrecoverable errors. See [Crash Dump](/v15.0/getting-started/setup/crash-dump) for full details.
...
- [JSON Object Data](/v15.0/reference/audit-destinations/json/object-data)
