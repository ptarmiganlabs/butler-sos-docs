...
The [log events overview page](/v15.0/concepts/monitoring/log-events/) has more info on this.
...
More info about Grafana alerts can be found in the [Grafana documentation](https://grafana.com/v15.0/grafana/latest/alerting/notifications/).  
New Relic alerts are described in the [New Relic documentation](https://docs.newrelic.com/v15.0/alerts-applied-intelligence/new-relic-alerts/learn-alerts/introduction-alerts/).
