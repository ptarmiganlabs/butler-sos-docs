...
- [Failed Poll Metrics](/v15.0/reference/available-metrics/failed-polls) for the exact InfluxDB schema used by these events
- [Error Tracking](/v15.0/concepts/features/error-tracking) for the broader Butler SOS error-tracking model