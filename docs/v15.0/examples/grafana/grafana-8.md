...
::: tip Dashboard file
The screenshots below are taken from the Grafana 8 demo dashboard that's [included in the Butler SOS repository](https://github.com/ptarmiganlabs/butler-sos/blob/master/v15.0/grafana/senseops_v7_0_dashboard.json).
...
Sample dashboards are available in the [Git repository](https://github.com/ptarmiganlabs/butler-sos/tree/master/v15.0/grafana).
...
- [Grafana Dashboards Overview](/v15.0/examples/grafana/)
- [Grafana 9 Dashboard](/v15.0/examples/grafana/grafana-9)
