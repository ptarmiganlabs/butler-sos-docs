...
- Store the data collected by Butler SOS in an InfluxDB v1 or v2 database. [InfluxDB setup instructions](/v15.0/getting-started/install/influxdb-grafana).
...
See the [config file format reference](/v15.0/reference/config-file-format) for details.
:::
...
- Learn about [engine performance monitoring](/v15.0/examples/engine-performance/) for more detailed app-level monitoring
- Explore [Grafana dashboards](/v15.0/examples/grafana/) for more visualization examples
- Review the [available metrics](/v15.0/reference/available-metrics/) to understand what data is available
