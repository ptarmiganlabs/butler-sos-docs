...
- [Grafana Dashboard Overview](/v15.0/examples/grafana/) - Introduction to Grafana dashboards for Butler SOS
- Version-specific dashboards with different features and capabilities

### New Relic Dashboards

New Relic provides a complete SaaS observability platform. See how to [visualize Butler SOS metrics in New Relic](/v15.0/examples/new-relic-dashboards).

### Event Counting

Learn how to [count user and log events](/v15.0/examples/count-user-log-events) received from Qlik Sense servers. This helps you understand if your Sense environment is healthy.

### Engine Performance Monitoring

Detailed tutorials for monitoring Qlik Sense engine performance:

- [Track app open times](/v15.0/examples/engine-performance/app-open-time) - Monitor how long it takes to open apps
- [Find slow updating charts](/v15.0/examples/engine-performance/find-slow-charts) - Identify which app objects are slow to update
