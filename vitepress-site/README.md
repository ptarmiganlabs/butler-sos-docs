...
This repository contains the [VitePress](https://vitepress.dev/) based documentation for [Butler SOS](https://github.com/ptarmiganlabs/butler-sos), which is an open source DevOps monitoring tool for [Qlik Sense Enterprise on Windows](https://www.qlik.com/us/products/qlik-sense).
